...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_email_is_public_str(self):
        test = User()
        self.assertEqual(str, type(test.email))

    def test_password_is_public_str(self):
        test = User()
        self.assertEqual(str, type(test.password))

    def test_first_name_is_public_str(self):
        test = User()
        self.assertEqual(str, type(test.first_name))

    def test_last_name_is_public_str(self):
        test = User()
        self.assertEqual(str, type(test.last_name))
